...
# HAT backbone size for SenHAT: one of 'tiny' | 'small' | 'base'
config.NETWORK.HAT_VARIANT = 'small'
...
config.TRAIN.data_path = os.environ.get(
    'SENHAT_TRAIN_DATA', '../sentinel_dataset/')
...
config.VALID = edict()
## test set location
config.VALID.data_path = os.environ.get(
    'SENHAT_VALID_DATA', '../sentinel_test/')
