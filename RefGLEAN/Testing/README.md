...
```python
python eval_glean.py --checkpoint_g ./weights/gens_glean.pt --checkpoint_d ./weights/discs_20m.pt --checkpoint_rgb ./weights/gens_esrgan.pt --batch 4 --evals --do_TA --nepoch 150 --data_path ../sentinel2_AOI5_clip.tif
```
