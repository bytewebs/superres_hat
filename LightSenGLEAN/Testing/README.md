# LightSenGLEAN Evaluation (All Bands)
...
```python
python infer_light_senglean.py --checkpoint_g ../weights/gens_light_senglean.pt --checkpoint_d ../weights/discs_all.pt --do_TA --data_path ../sentinel2_AOI5_clip.tif
```

### Arguments

```python
usage: infer_light_senglean.py [-h] [--do_TA] [--evals]
...
```python
python eval_light_glean_all.py --checkpoint_g ../weights/gens_light_senglean.pt --checkpoint_d ../weights/discs_all.pt --batch 4 --evals --do_TA --nepoch 150 --data_path ../sentinel2_AOI5_clip.tif
```

### Arguments

```python
usage: eval_light_glean_all.py [-h] [--do_TA] [--evals]
                           [--checkpoint_g CHECKPOINT_G]
                           [--checkpoint_d CHECKPOINT_D]
                           [--data_path DATA_PATH] [--batch BATCH]
                           [--nepoch NEPOCH] [--artif]
